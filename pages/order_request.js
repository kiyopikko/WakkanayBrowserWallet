  ...
  return (
    <Layout>
      <div className="order-request-page">
        <div className="exchange-order-request-title-box">Exchange Order Request</div>
        ...
        <div className="expected-balance-box">
          ...
          <div className="expected-balance-contents">
            <div className="token-expected-balance-box">
              <div className="token-new-amount">
                <div className="token-new-amount-in-eth">
                  <span className="token-new-amount-text">1.05</span><span className="token-type-unit">ETH</span>
                </div>
            ...
            <div className="token-expected-balance-box">
              <div className="token-new-amount">
                <div className="token-new-amount-in-eth">
                  <span className="token-new-amount-text">70</span><span className="token-type-unit">DAI</span>
                </div>
