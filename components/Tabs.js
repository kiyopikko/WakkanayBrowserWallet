...
const Tabs = () => {
  ...
  return (
    <div>
      <div className="tabs">
        <div className={classNames("tab", { selected: router.route === "/home" }, "home-tab")}>
          <Link href="./home"><a className="tab-item">Home</a></Link>
        </div>
        <div className={classNames("tab", { selected: router.route === "/send"||router.route === "/receive" })}>
          <Dropdown buttonName="Payment" items={[
          {name: "Send", href: "/send"},
          {name: "Receive Request", href: "/receive"}]} />
        </div>
        <div className={classNames("tab", { selected: router.route === "/order_request"|| router.route ==="/order_book" })}>
          <Dropdown buttonName="Exchange" items={[
          {name:"Order Request", href:"/order_request"},
          {name: "Order Book", href:"order_book"}]} />
        </div>
        <div className={classNames("tab", { selected: router.route === "/nft_collections"|| router.route ==="/nft_trade" })}>
