  ...
  return (
    <div className="account-info">
      <div className="account-info-box">
        <img className="profile-picture" src="yuriko-profile-picture.jpg" alt="Yuriko Profile Picture"></img>
        ...
        <CopyToClipboard text="0x5153…1BaC" onCopy={console.log}>
          <div className="account-address-set" data-tip='React-tooltip'>
            ...
            <div className="copy-button"><FontAwesomeIcon icon="clipboard" /></div>
          </div>
        </CopyToClipboard>
        <ReactTooltip place="bottom" type="dark" effect="solid"><span>Copy to Clipboard</span></ReactTooltip>
        ...
        <div className="token-box">
            <img className="eth-logo" src="../ethereum-icon.png" art="ETH Token Logo" />
            <div className="token-amount-box">
              <div className="token-amount-in-crypto-box">
                <div className="token-amount">2.4797</div><div className="token-type">ETH</div>
              </div>
